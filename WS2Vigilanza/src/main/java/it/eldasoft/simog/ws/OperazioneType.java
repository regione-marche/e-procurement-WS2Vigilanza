...
public class OperazioneType implements java.io.Serializable {
    ...
    public static final OperazioneType DEL = new OperazioneType(_DEL);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://ws.simog.eldasoft.it/", "operazioneType"));
    }
    /**
