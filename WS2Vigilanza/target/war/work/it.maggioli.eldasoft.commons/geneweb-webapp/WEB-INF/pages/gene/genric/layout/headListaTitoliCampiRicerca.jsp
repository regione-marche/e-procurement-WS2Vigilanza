...
<!--
	...
	function modifica(id){
		var metodo = "modifica";
		document.location.href = 'ListaTitoliCampiRicerca.do?metodo=' + metodo + '&id=' + id;
	}
	...
	function spostaInPosizioneMarcata(id){
		...
		if (numeroOggetti == 0)
			...
			if (id == posizioneSelezionata)
				...
				bloccaRichiesteServer();
				document.location.href = 'ListaTitoliCampiRicerca.do?metodo=spostaInPosizioneMarcata&id=' + id + '&idNew=' + posizioneSelezionata;
			}
		}
	}
	...
	function eseguiRicerca(){
		...
		//</c:if>
		bloccaRichiesteServer();
		document.location.href='ControllaDatiRicerca.do?tab=LAY'
	}
