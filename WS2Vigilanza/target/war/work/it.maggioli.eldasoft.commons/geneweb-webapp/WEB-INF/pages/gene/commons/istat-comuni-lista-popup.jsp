...
<gene:template file="popup-template.jsp">
	...
	<gene:redefineInsert name="corpo">
		<gene:formLista pagesize="25" tableclass="datilista" 
			...
			<gene:formSelect>
				select tabsche.tabdesc, tb1.tabcod3, tb1.tabdesc, tabsche.tabcod3, tabsche.tabcod4 
			...
			<gene:campoLista title="Comune" entita="TABSCHE" campo="TABDESC" definizione="T120" headerClass="sortable" href="javascript:archivioSeleziona(${datiArchivioArrayJs});"/>
			<gene:campoLista title="Comune" entita="TB1" campo="TABCOD3" definizione="T5" headerClass="sortable" visibile="false" />
			<gene:campoLista title="Provincia" entita="TB1" campo="TABDESC" definizione="T120" headerClass="sortable" />
